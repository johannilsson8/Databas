...
CREATE TABLE `attendings` (
  ...
  KEY `S_ID` (`S_ID`),
  KEY `C_ID` (`C_ID`),
  CONSTRAINT `attendings_ibfk_1` FOREIGN KEY (`S_ID`) REFERENCES `students` (`S_ID`),
  CONSTRAINT `attendings_ibfk_2` FOREIGN KEY (`C_ID`) REFERENCES `courses` (`C_ID`)
...
INSERT INTO `attendings` VALUES (1,'jonu20','Johan','Nilsson','MA1445','Analys 2');
